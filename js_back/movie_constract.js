...
var MovieItem = function(text) {
	if (text) {
        ...
        this.movieGetCode = obj.movieGetCode;
	} else {
	    this.from = "";
        this.name = "";
        this.description = "";
...
var MovieSys = function() {
    ...
    LocalContractStorage.defineMapProperty(this, "movie_list", {
        parse: function (text) {
    ...
    LocalContractStorage.defineProperty(this, "movie_list_size");
    // 定义一个存储string的list
    LocalContractStorage.defineMapProperty(this, "movie_list_array");
...
MovieSys.prototype = {
    ...
    add_movie_to_list: function(text) {
        ...
        if(result.success){
            ...
            obj.movieGetCode = obj.movieGetCode.trim();


            if(obj.from == "" || obj.name===""|| obj.description===""||obj.showTime==="" || obj.uploadTime === "" || obj.fileType == "" || obj.fileSize == ""
                 || obj.downloadUrl == "" || obj.downloadType == ""){
                addResult.success = false;
                addResult.message = "empty from / name / description / showTime / uploadTime / fileType /fileSize / downloadUrl / downloadType";
                return addResult;
            }
            ...
            movie.movieGetCode = obj.movieGetCode;
